...
form이라는 태그 내에 input 태그, button 태그들로 구성되어 있고 form이 시작되는 form 태그 내부에서는 action과 method의 속성을 기술하도록 되어 있습니다.



쟝고에서는 이러한 폼을 구성하기 쉽도록 프레임워크 단에서 지원하고 있습니다. 그 특징은 다음과 같습니다.
